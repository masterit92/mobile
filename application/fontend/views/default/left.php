    ...
    <div class="menu_left">
        ...
        <div class="left_content">
            ...
            foreach($data['makers'] as $makers):
                ...
                ?>
                <input type="checkbox" <?php echo (isset($checked)) ? $checked : ''?> class="event_makers" id="<?php echo 'makerid_' . $makers['m_id']?>" name="cb_maker[]" id="<?php echo $makers['m_id']?>"/> <?php echo $makers['name']?>
                <br/>
                <?php
            endforeach;
            ?>
