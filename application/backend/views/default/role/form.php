        ...
        <fieldset id="personal">
            ...
            <ol>
                ...
                <li><label for="role name"  class="required">Role Name<span>*</span></label>
                    <input name="role_name" type="text" id="role_name" value="<?php echo (isset($role))? $role['name']:''?>" placeholder="Role Name" class="required" />	
                </li>
            </ol>
        </fieldset>
        <fieldset id="submitform">
            <input type="submit" id="formsubmit" name="save" value="<?php echo (isset($role))?'Edit Role':'Create Role'?>" />
