...
<div id="content">
    <h1>Form Product</h1>
    <form action="<?php echo base_url('admin/product/save')?>" method="post" id="input_form" enctype="multipart/form-data">
        ...
        <fieldset id="personal">
            ...
            <ol>
                <li><label for="Product name"  class="required">Product Name<span>*</span></label>
                    <input name="product_name" type="text" id="product_name" value="<?php echo isset($product) ? $product['name'] : ''?>" placeholder="Product Name" class="required" />	
                </li>
                <li><label for="Thumb"  class="required">Thumb<span>*</span></label>
                    <input type="file" name="thumb"/>	
                </li>
                <li><label for="Price"  class="required">Price<span>*</span></label>
                    <input name="price" type="text" id="price" value="<?php echo isset($product) ? $product['price'] : ''?>" placeholder="Price" class="required" />	
                </li>
                <li><label for="Description"  class="required">Description<span>*</span></label>
                    <input name="description" type="text" multiple  id="description" value="<?php echo isset($product) ? $product['description'] : ''?>" placeholder="Description" class="required" />	
                </li>
                <li><label for="Quantity"  class="required">Quantity<span>*</span></label>
                    <input name="quantity" type="text" id="quantity" value="<?php echo isset($product) ? $product['quantity'] : ''?>" placeholder="Quantity" class="required" />	
                </li>
                ...
                <li><label for="Checked show Banner" >Checked show banner<span>*</span></label>
                    <input type="checkbox" name="selected" <?php echo (isset($product) && $product['selected'] == 1) ? 'checked' : ''?> />	
                </li>
            </ol>
        </fieldset>
        <fieldset id="submitform">
            <input type="submit" id="formsubmit" name="save" value="<?php echo (isset($product)) ? 'Edit Category' : 'Create Category'?>" />
